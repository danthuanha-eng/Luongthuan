...
<div class="main-header">
    ...
    <p>Tác giả: Lương Thị Thuân - Trường Tiểu học Vĩnh Thành - ĐT: 0988257087</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lương Thị Thuân - Trường Tiểu học Vĩnh Thành - ĐT: 0988257087</div>", unsafe_allow_html=True)
